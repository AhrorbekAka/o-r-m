...
<div id="img2" class="contentt">
    ...
    <sql:query var="rs" dataSource="${orm}">SELECT id,name,price,preparation_time,description FROM meal where (available
    = true) and (type = 'FIRST') </sql:query>
            ...
            <c:forEach items="${rs.rows}" var="meal">
                <form action="paid">
                    <tr>
                        ...
                        <td>
                            <button name="meal" value="${meal.id}">Order</button>
                        </td>
    ...
    <sql:query var="rs" dataSource="${orm}">SELECT id,name,price,preparation_time,description FROM meal where (available
    = true) and (type = 'SECOND') </sql:query>
    ...
    <sql:query var="rs" dataSource="${orm}">SELECT id,name,price,preparation_time,description FROM meal where (available
    = true) and (type = 'DESERT') </sql:query>
